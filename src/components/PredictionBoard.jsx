...
export const PredictionBoard = ({ onSelectPlay, activePlayId }) => {
  ...
  const poolStakedOutcome1 = parseFloat(selectedPool.stakedOutcome1);
  const poolStakedOutcome2 = parseFloat(selectedPool.stakedOutcome2);
  const poolTotal = parseFloat(selectedPool.totalStaked);
    ...
    <div className="prediction-board-layout">
      ...
      <div className="fast-trade-section">
        ...
        <div className="fast-trade-card">
          ...
          >
            {loading ? 'BROADCASTING...' : walletConnected ? 'SUBMIT PREDICTION' : 'CONNECT TO PLACE'}
          </button>
        </div>
      </div>
